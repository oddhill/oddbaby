...
!(function (e, t, n) {
  function r(e, t) {
    ...
    var e, t, n, o, s, i, a;for (var l in y) if (y.hasOwnProperty(l)) {
      if ((e = [], t = y[l], t.name && (e.push(t.name.toLowerCase()), t.options && t.options.aliases && t.options.aliases.length))) for (n = 0; n < t.options.aliases.length; n++) e.push(t.options.aliases[n].toLowerCase());for (o = r(t.fn, "function") ? t.fn() : t.fn, s = 0; s < e.length; s++) i = e[s], a = i.split("."), 1 === a.length ? Modernizr[a[0]] = o : (!Modernizr[a[0]] || Modernizr[a[0]] instanceof Boolean || (Modernizr[a[0]] = new Boolean(Modernizr[a[0]])), Modernizr[a[0]][a[1]] = o), C.push((o ? "" : "no-") + a.join("-"));
    }
  }function s(e) {
    var t = E.className,
    ...
    var s,
        ...
        u = "modernizr",
        d = a("div"),
        p = l();if (parseInt(r, 10)) for (; r--;) c = a("div"), c.id = o ? o[r] : u + (r + 1), d.appendChild(c);return (s = a("style"), s.type = "text/css", s.id = "s" + u, (p.fake ? p : d).appendChild(s), p.appendChild(d), s.styleSheet ? s.styleSheet.cssText = e : s.appendChild(t.createTextNode(e)), d.id = u, p.fake && (p.style.background = "", p.style.overflow = "hidden", f = E.style.overflow, E.style.overflow = "hidden", E.appendChild(p)), i = n(d, e), p.fake ? (p.parentNode.removeChild(p), E.style.overflow = f, E.offsetHeight) : d.parentNode.removeChild(d), !!i);
  }function f(e) {
    ...
    var o = t.length;if ("CSS" in e && "supports" in e.CSS) {
      ...
      for (var s = []; o--;) s.push("(" + f(t[o]) + ":" + r + ")");return (s = s.join(" or "), c("@supports (" + s + ") { #modernizr { position: absolute; } }", function (e) {
    ...
    }for (var f, p, m, h, g, v = ["modernizr", "tspan"]; !k.style;) f = !0, k.modElem = a(v.shift()), k.style = k.modElem.style;for (m = e.length, p = 0; m > p; p++) if ((h = e[p], g = k.style[h], i(h, "-") && (h = d(h)), k.style[h] !== n)) {
    ...
    var o;for (var s in e) if (e[s] in t) return n === !1 ? e[s] : (o = t[e[s]], r(o, "function") ? m(o, n || t) : o);return !1;
  ...
  }), Modernizr.addTest("csstransitions", v("transition", "all", !0)), Modernizr.addTest("svg", !!t.createElementNS && !!t.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect), o(), s(C), delete S.addTest, delete S.addAsyncTest;for (var F = 0; F < Modernizr._q.length; F++) Modernizr._q[F]();e.Modernizr = Modernizr;
})(window, document);
